...
public class BankApplication {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext appContext = new ClassPathXmlApplicationContext("application-context.xml", "test-clients.xml");

        Banking banking = initialize(appContext);

        workWithExistingClients(banking);

        bankingServiceDemo(banking);

        bankReportsDemo(appContext);
